...
**Higher is better.** This refreshed 2026-09-21 snapshot measures `7852e2e`
(including strided TPMV kernels and bounded transpose input staging) using a baseline-CPU,
