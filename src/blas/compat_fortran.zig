...
pub const caxpy_ = compat.caxpy_;
pub const zaxpy_ = compat.zaxpy_;
pub const caxpby_ = compat.caxpby_;
pub const zaxpby_ = compat.zaxpby_;
pub const dscal_ = compat.dscal_;
pub const cscal_ = compat.cscal_;
pub const zscal_ = compat.zscal_;
